...
<head>
  ...
  <title>Doctor Registration - Professional Credentials</title>
  ...
  <main class="form-page">
    <div class="container">
      <div class="form-card">
        ...
        <form method="POST" action="index.php?action=doctor_add&step=3" enctype="multipart/form-data">
          <div class="form-grid">
            <div class="form-group">
              <label for="qualification">Highest Qualification</label>
              <input id="qualification" name="qualification" type="text" value="<?php echo htmlspecialchars($values['qualification'] ?? ''); ?>" placeholder="Enter highest qualification" />
            </div>
          ...
          <div class="form-actions">
            <button type="button" class="btn btn-secondary-outline" onclick="window.location.href='index.php?action=doctor_add&step=2'">Back</button>
            <button type="submit" name="submit_all" class="btn btn-primary">Finish & Submit</button>
          </div>
        </form>
      </div>
    </div>
