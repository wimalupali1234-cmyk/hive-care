<?php
// expects: $facilityTests (array), optional $message (string)
$facilityTests = $facilityTests ?? [];
$message = $message ?? '';
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Facility Tests - HIVeCare</title>
...
<main>
  ...
  <div class="back-button-container">
    ...
    <h1 class="page-title">Facility Based Tests</h1>
    ...
    <div class="table-container">
      <table id="Table" style="width:100%; border-collapse:collapse; border: 2px solid #ddd; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
        ...
        <tbody>
          <?php foreach ($facilityTests as $row): ?>
            <?php
              // prepare safe values
            ...
            ?>
            <form class="row-form" method="POST" action="index.php?action=facilitytest" novalidate>
