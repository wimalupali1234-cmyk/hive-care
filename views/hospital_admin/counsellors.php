...
<head>
  <meta charset="UTF-8">
  <title>Manage Counsellors - HIVeCare</title>
...
<header class="header">
  <h1><i class="fas fa-user-tie"></i> Manage Counsellors</h1>
  ...
  <div class="manage-container">
    ...
    <div class="left-column">
      ...
      <form>
        ...
        <button type="submit" class="add-btn">+ Add Counsellor</button>
      </form>
    </div>

    <!-- Right Column (Counsellor Cards) -->
    <div class="right-column">
      <div class="hospital-grid">
        <!-- Counsellor Card Example -->
        <div class="hospital-card">
          <h3><i class="fas fa-user-tie"></i> Jane Doe</h3>
          ...
          <p><i class="fas fa-graduation-cap"></i> BSc Counselling</p>
        ...
        <div class="hospital-card">
          <h3><i class="fas fa-user-tie"></i> John Smith</h3>
          ...
          <p><i class="fas fa-graduation-cap"></i> MSc Counselling</p>
        ...
        <!-- Add more static counsellor cards as needed -->
