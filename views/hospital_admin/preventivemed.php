...
<main>
   <div class="container" style="padding: 60px 0;">
    <h1 style="color: var(--primary-color); text-align: center; margin-bottom: 30px;">
      Preventive Medication Inventory
    </h1>

    <!-- Medication Table -->
    <table id="medTable" style="width: 100%; border-collapse: collapse; background-color: var(--white); box-shadow: var(--box-shadow); border-radius: var(--border-radius); overflow: hidden;">
      <thead>
        <tr style="background-color: #f8f9fa;">
          <th style="padding: 14px 20px; text-align: left;">Medication Name</th>
